...
const solveProblemSchema = {
    ...
    properties: {
        answer: {
            type: Type.STRING,
            description: 'The final numerical or symbolic answer to the problem.',
        },
        steps: {
            type: Type.ARRAY,
...
export async function solveProblem(problem: string): Promise<Solution> {
    const prompt = `Solve the following math or physics problem and provide the answer and a step-by-step solution. Problem: "${problem}"`;
