                ...
                <div className="flex items-center gap-2">
                    ...
                    {Array.from({ length: integrationCount }).map((_, i) => (
                         <div key={i} className="flex items-center">
                            ...
                            <InputWrapper value={variables[i]} onClear={() => handleVariableChange(i, '')} disabled={isLoading}>
                                <input
                                    type="text"
                                    value={variables[i]}
                    ...
                    <div className="space-y-2 p-2 bg-black/5 dark:bg-black/20 rounded-2xl">
                        ...
                        {Array.from({ length: integrationCount }).map((_, i) => (
                             <div key={i} className="flex items-center justify-center gap-2">
                                ...
                                <InputWrapper value={bounds[i].lower} onClear={() => handleBoundsChange(i, 'lower', '')}>
                                ...
                                <InputWrapper value={bounds[i].upper} onClear={() => handleBoundsChange(i, 'upper', '')}>
