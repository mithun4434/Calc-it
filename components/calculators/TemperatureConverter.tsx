...
const TemperatureConverter: React.FC = () => {
    ...
    const inputClasses = "w-full text-center p-3 bg-black/10 dark:bg-black/20 border border-current/10 rounded-3xl focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-colors text-2xl";
        ...
        <div className="glass-panel w-full max-w-sm mx-auto p-4 sm:p-6 space-y-6 rounded-3xl">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <InputWrapper value={values.celsius} onClear={clearAll}>
                ...
                <div>
                    ...
                    <InputWrapper value={values.fahrenheit} onClear={clearAll}>
                ...
                <div>
                    ...
                    <InputWrapper value={values.kelvin} onClear={clearAll}>
